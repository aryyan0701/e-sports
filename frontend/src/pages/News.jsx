...
function News() {
  ...
  {status === "succeeded" &&
    news.map((event) => (
      <div
        key={event._id}
        className="bg-white shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-2 rounded-lg overflow-hidden"
      >
        ...
        <div className="p-6">
          <h2 className="text-blue-600 font-extrabold text-xl mb-2">
          ...
          <div className="flex justify-between items-center">
            <div className="bg-blue-100 text-blue-600 px-3 py-1 rounded-full shadow-sm">
              Source: {event.source}
            </div>
            <a
